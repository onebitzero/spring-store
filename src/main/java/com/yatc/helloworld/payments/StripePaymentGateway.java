...
import com.yatc.helloworld.entities.OrderItem;
import com.yatc.helloworld.entities.PaymentStatus;
...
public class StripePaymentGateway implements PaymentGateway {
    ...
    private final static Logger logger = LoggerFactory.getLogger(StripePaymentGateway.class);
    ...
    public CheckoutSession createCheckoutSession(Order order) {
        try {
            ...
            SessionCreateParams sessionCreateParams = SessionCreateParams.builder()
                    ...
                    .setSuccessUrl(clientUrl + "/checkout-success?orderId=" + order.getId())
    ...
    public Optional<PaymentResult> parseWebhookRequest(WebhookRequest request) {
        try {
            ...
            logger.info("webhook event: {}", event.getType());
    ...
    private Long extractOrderId(Event event) {
        StripeObject stripeObject = event.getDataObjectDeserializer().getObject().orElseThrow(
                () -> new PaymentException("Couldn't deserialize Stripe event")
        );
